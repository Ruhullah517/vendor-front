...
const mockPackageData = {
    packageName: "Boss Pakwan Centre",
    packageType: "Catering",
    foodItem: "Admin",
    description: "boss123@reez",
    totalServing: "your present address",
    addOns: "karachi",
    price: "233",
    preparationTime: "23433",
    deliveryTime: null,
    packageTypes: ["Buffet", "Box Meal", "Daig"],
            ...
            <div className="max-w-3xl p-4 md:p-6">
                ...
                <div className="flex gap-10 cursor-pointer">
                    <div className="mb-8" onClick={() => setActiveTab("info")}>
                        ...
                        {activeTab === "info" && <div className="h-0.5 w-24 bg-pink-500 mt-1"></div>}
                    </div>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                ...
                                                <div className="space-y-0">
                                                    ...
                                                    <input
                                                        ...
                                                        className="rounded-xl w-70 text-sm border border-[#9E033B] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                                                    />
                                                </div>
                                                <div className="space-y-0">
                                                    ...
                                                    <select
                                                        ...
                                                        className="rounded-xl w-70 text-sm border border-[#9E033B] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                                                    >
                                                        {mockPackageData.packageTypes.map((type) => (
                            ...
                            activeTab === "detail" && (
                                <div className="w-200">
                                    <div className="rounded-lg overflow-hidden">
                                        <div className="pb-2">
                                            <h2 className="text-lg font-semibold text-pink-600">Package Details</h2>
                                        </div>
                                        <div className="space-y-0 border-1 border-[#9E033B] rounded-xl p-4">
                                            <div className="space-y-0">
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Package Name:</span>
                                                    <span>{formData.packageName}</span>
                                                </div>
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Package type:</span>
                                                    <span>{formData.packageType}</span>
                                                </div>
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Food Items:</span>
                                                    <span>{formData.foodItem}</span>
                                                </div>
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Price:</span>
                                                    <span>Rs. {formData.price} PKR</span>
                                                </div>
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Total serving:</span>
                                                    <span>{formData.totalServing} people</span>
                                                </div>
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Preparation time:</span>
                                                    <span>{formData.preparationTime} days</span>
                                                </div>
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Delivery time:</span>
                                            ...
                                            <div className="space-y-0">
                                                <div className="flex">
                                                    <span className="font-semibold text-sm w-36">Description:</span>
                                                </div>
