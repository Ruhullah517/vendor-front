...
const mockVendorData = {
  ...
  postalCode: "23433",
  profileImage: null,
  businessTypes: ["Catering", "Restaurant", "Food Truck", "Cafe", "Bakery"],
            ...
            <div className="flex-grow">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="space-y-0">
                  <div htmlFor="vendorName" className="text-pink-500 text-sm pb-1">Vendor Name</div>
                  <input
                    id="vendorName"
                    name="vendorName"
                ...
                <div className="space-y-0">
                  <div htmlFor="businessType" className="text-pink-500 text-sm pb-1">Business Type</div>
                  <select
                    id="businessType"
                    name="businessType"
                ...
                <div className="space-y-0">
                  <div htmlFor="userName" className="text-pink-500 text-sm pb-1">Username</div>
                  <input
                    id="userName"
                    name="userName"
                ...
                <div className="space-y-0">
                  <div htmlFor="password" className="text-pink-500 text-sm pb-1">Password</div>
                  <input
                    id="password"
                    name="password"
                ...
                <div className="space-y-0">
                  <div htmlFor="address" className="text-pink-500 text-sm pb-1">Present Address</div>
                  <input
                    id="address"
                    name="address"
                ...
                <div className="space-y-0">
                  <div htmlFor="city" className="text-pink-500 text-sm pb-1">City</div>
                  <select
                    id="city"
                    name="city"
                    value={formData.city}
                ...
                <div className="space-y-0">
                  <div htmlFor="totalWorkers" className="text-pink-500 text-sm pb-1">Total workers</div>
                  <input
                    id="totalWorkers"
                    name="totalWorkers"
                ...
                <div className="space-y-0">
                  <div htmlFor="postalCode" className="text-pink-500 text-sm pb-1">Postal Code</div>
                  <input
                    id="postalCode"
                    name="postalCode"
