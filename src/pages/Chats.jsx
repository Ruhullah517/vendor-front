...
export default function Chats() {
  ...
  const handleChatClick = (order) => {
    ...
    navigate(`/messages/${chatId}`, { state: { chatData: order } })
  }
          ...
          <table className="w-full">
            ...
            <tbody>
              {orders.map((order) => (
                <tr 
                  key={order.id} 
                  className="hover:shadow-[0_-2px_4px_-1px_rgba(0,0,0,0.1),0_8px_10px_-1px_rgba(0,0,0,0.1)] hover:scale-[1] duration-200 rounded-lg cursor-pointer"
