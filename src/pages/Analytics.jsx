      ...
      <div className="container mx-auto p-4">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex  justify-between items-end ">
            {/* Top Selling Packages */}
            <div className="mb-8 p-6 bg-[#FFF5F6] w-160 rounded-lg flex flex-col gap-4">
            ...
            {/* Activity Section */}
            <div className="mb-6 bg-[#FFF5F6] rounded-xl shadow p-6 w-80">
              {/* Header */}
              ...
              {/* Button */}
              <button className="mt-6 w-full cursor-pointer flex items-center justify-center gap-2 text-sm font-semibold border border-[#e91e63] text-[#e91e63] py-2 rounded-lg hover:bg-[#ffe6ec] transition-all">
                View all activity
